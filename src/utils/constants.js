...
export const TIME_STAMPS_LABELS = [{value: TIME_STAMPS.oneHour , label:'1 Hour'},{value: TIME_STAMPS.sixHour , label:'6 Hour'},{value: TIME_STAMPS.oneDay , label:'1 Day'},{value: TIME_STAMPS.sevenDay , label:'7 Days'},{value: TIME_STAMPS.oneMonth , label:'1 Month'}, {value: TIME_STAMPS.threeMonth , label:'3 Month'},{value: TIME_STAMPS.oneYear , label:'1 Year'},{value: TIME_STAMPS.threeYear , label:'3 Year'}];